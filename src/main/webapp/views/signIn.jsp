...
<form action="/MK-JD2-88-22-1.0-SNAPSHOT/signIn" method="POST">
    <table>
        <tbody>
            <tr>
    ...
    <p><input type="button" onclick="location.href='/MK-JD2-88-22-1.0-SNAPSHOT/signUp';" value="Back to registration" /></p>
</form>
</body>
</html>